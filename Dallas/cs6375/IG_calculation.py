...
trainFile = "D:/mycode/utdallas/cs6375/Decision-tree-post-pruning/data_sets1/training_set.csv"
...
for row in reader:
    if(rownum == 0):
        ...
        if any(row):
            ...
            result = bestAttribute(data, header)
            print(result)

...
g8    0.039   13.5    40    42.6    42.6    22    22    3   2   95   95   0     1     0    0     0     1    0    0
g9    0.039   15.0    25    50.6    50.6    16    16    0   0   85   85   0     1     0    0     0     0    1    0
...
igdtlp(t) .. dataLP(t, 'WT') =e= dataLP(t, 'WT') * (alpha + 1);


Parameter data(t, k, i, *);

data(t, k, i, 'DP') = (gendata(i, "Pmax") + gendata(i, 'e')*dataLP(t, 'PV') + gendata(i, 'f')*dataLP(t, 'WT') - gendata(i, "Pmin")) / card(k);
data(t, k, i, 'Pini') = (ord(k) - 1) * data(t, k, i, 'DP') + gendata(i, "Pmin");
data(t, k, i, 'Pfin') = data(t, k, i, 'Pini') + data(t, k, i, 'DP');
data(t, k, i, 'Cini') = gendata(i, "a") * power(data(t, k, i, 'Pini'), 2) + gendata(i, "b") * data(t, k, i, 'Pini') + gendata(i, "c");
data(t, k, i, 'Cfin') = gendata(i, "a") * power(data(t, k, i, 'Pfin'), 2) + gendata(i, "b") * data(t, k, i, 'Pfin') + gendata(i, "c");
data(t, k, i, 's') = (data(t, k, i, 'Cfin') - data(t, k, i, 'Cini')) / data(t, k, i, 'DP');
...
Pk.up(i, t, k) = data(t, k, i, 'DP') + gendata(i, 'e')*dataLP(t, 'PV') + gendata(i, 'f')*dataLP(t, 'WT');
Pk.lo(i, t, k) = 0;

pu.up(i, t) = gendata(i, "Pmax") + gendata(i, 'e')*dataLP(t, 'PV') + gendata(i, 'f')*dataLP(t, 'WT');

Equations Uptime1, Uptime2, Uptime3, Dntime1, Dntime2, Dntime3, Ramp1, Ramp2, Ramp3, Ramp4, startc, shtdnc, genconst1, Genconst2, Genconst3, Genconst4, balance, reserve, igdtbc, igdtof;
...
Genconst3(i, t, k) .. Pk(i, t, k) =l= U(i, t) * data(t, k, i, 'DP');
Genconst4 .. costThermal =e= sum((i, t), StC(i, t) + SDC(i ,t)) + sum((t, i), u(i, t)*gendata(i, 'Mincost') + sum(k, data(t, k, i, 's')*pk(i, t, k)));
...
igdtof ..   costThermal =l= BC;

Model UCLP /all/;
Option optcr = 0.0;
Solve UCLP maximizing alpha using minlp;

File results / sssr3.txt /;
results.ap = 1
put results;
loop((t),
     loop((i),
